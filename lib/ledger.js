...
var LedgerSigner = /** @class */ (function (_super) {
    ...
    function LedgerSigner(provider, path, resolutionConfig) {
        var _this = _super.call(this) || this;
        if (path == null) {
            path = defaultPath;
        }
        if (resolutionConfig) {
            _this._resolutionConfig = resolutionConfig;
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        loadConfig = {};
                        resolutionConfig = this._resolutionConfig ? this._resolutionConfig : { externalPlugins: true, erc20: true };
